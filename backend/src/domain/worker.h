...
class Worker {
  public:
    ...
    virtual void UpdatePayrollSheet(const domain::PayrollSheet& payroll_sheet) = 0;

    virtual void AddPersonnelEvent(const domain::PersonnelEvent& personnel_event) = 0;
    virtual void UpdatePersonnelEvent(const domain::PersonnelEvent& personnel_event) = 0;
