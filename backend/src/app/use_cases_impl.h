...
class UseCasesImpl : public UseCases {
  public:
    ...
    std::vector<ui::detail::PayrollSheetInfo> GetPayrollSheetForPerson(int personnel_number) const override;
    ...
    std::vector<ui::detail::PersonnelEventInfo> GetPersonnelEventsForPerson(int personnel_number) const override;
